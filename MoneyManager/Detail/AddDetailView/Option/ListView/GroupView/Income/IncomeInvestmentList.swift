...
struct IncomeInvestmentList: View {
    @EnvironmentObject var addDetailVM: AddDetailViewModel
    @Environment(\.dismiss) var dismiss
    
    var body: some View {
        List(IncomeInvestment.allCases, id: \.self) { type in
            Button {
...
struct IncomeInvestmentList_Previews: PreviewProvider {
