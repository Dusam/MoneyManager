...
struct ExpensesClothingList: View {
    @EnvironmentObject var addDetailVM: AddDetailViewModel
    @Environment(\.dismiss) var dismiss
    
    var body: some View {
        List(ExpensesClothing.allCases, id: \.self) { type in
            Button {
...
struct ExpensesClothingList_Previews: PreviewProvider {
